...
public class Circle implements Serializable {
    ...
    /**
     * Constructs a new circle with the given X and Y coordinates
    ...
    /**
     * Constructs a new circle using a given {@link com.guidebee.math.Vector2} that
     * contains the desired X and Y coordinates, and a given radius.
     *
     * @param position The position {@link com.guidebee.math.Vector2}.
     ...
     * {@link Circle} of the form {@code x, y, radius}.
     */
    @Override
     ...
     * (as 2 * {@link com.guidebee.math.MathUtils#PI2}) * {@code radius}
     */
     ...
     * (as {@link MathUtils#PI} * radius * radius).
     */
    public float area() {
