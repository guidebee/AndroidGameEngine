 ...
 * with ArrayList<Float>. If unordered, this class
 * avoids a memory copy when removing elements (the last element is moved to
...
public class FloatArray {
     ...
     * ordered. The capacity is set to the number of elements, so any
    ...
    /**
     * Reduces the size of the backing array to the size of the actual items. This is
     * useful to release memory when many items have
