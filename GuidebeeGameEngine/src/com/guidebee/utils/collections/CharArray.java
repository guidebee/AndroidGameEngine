 ...
 * with ArrayList<Character>. If unordered, this class
...
public class CharArray {
     ...
     * new array will be ordered if the specific array is
     ...
     * array. The capacity is set to the number of elements,
     ...
     * is useful to release memory when many items have
