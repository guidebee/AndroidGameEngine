...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * An unordered map that uses int keys. This implementation is a cuckoo
 * hash map using 3 hashes, random walking, and a small stash
 * for problematic keys. Null values are allowed. No allocation is done
...
public class IntMap<V> implements Iterable<IntMap.Entry<V>> {
    ...
    private void push(int insertKey, V insertValue, int index1, int key1, int index2,
     ...
     * done. If the map contains more items than the specified capacity,
    ...
    /**
     * Returns the key for the specified value, or <tt>notFound</tt> if it is not
     * in the map. Note this traverses the entire map
     ...
     * the same iterator instance is returned each
     * time this method is called. Use the {@link Entries} constructor for nested
     * or multithreaded iteration.
     */
    ...
    static public class Entries<V> extends MapIterator<V>
