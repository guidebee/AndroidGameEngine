 ...
 * using 3 hashes, random walking, and a small stash
...
public class IntSet {
     ...
     * This set will hold 25 items before growing the
     * backing table.
     */
    public IntSet() {
        this(32, 0.8f);
     ...
     * This set will hold initialCapacity * loadFactor items
    ...
    private void push(int insertKey, int index1, int key1, int index2, int key2,
                      int index3, int key3) {
        int[] keyTable = this.keyTable;
     ...
     * done. If the set contains more items than the specified capacity,
     ...
     * this method is called. Use the {@link IntSetIterator} constructor
