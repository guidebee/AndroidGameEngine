...
public class Cubemap extends GLTexture {
    ...
    public enum CubemapSide {
         ...
         */
        PositiveX(0, IGL20.GL_TEXTURE_CUBE_MAP_POSITIVE_X),
        /**
         * The negative X and second side of the cubemap
         */
        NegativeX(1, IGL20.GL_TEXTURE_CUBE_MAP_NEGATIVE_X),
        /**
         * The positive Y and third side of the cubemap
         */
        PositiveY(2, IGL20.GL_TEXTURE_CUBE_MAP_POSITIVE_Y),
        /**
         * The negative Y and fourth side of the cubemap
         */
        NegativeY(3, IGL20.GL_TEXTURE_CUBE_MAP_NEGATIVE_Y),
        /**
         * The positive Z and fifth side of the cubemap
         */
        PositiveZ(4, IGL20.GL_TEXTURE_CUBE_MAP_POSITIVE_Z),
        /**
         * The negative Z and sixth side of the cubemap
         */
        NegativeZ(5, IGL20.GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
    ...
    /**
     * Construct an empty Cubemap. Use the load(...) methods to set the
     * texture of each side. Every side of the cubemap must be set
     * before it can be used.
     */
    public Cubemap() {
        this((TextureData) null, (TextureData) null, (TextureData) null,
                (TextureData) null, (TextureData) null, (TextureData) null);
    }
     ...
     */
    public Cubemap(FileHandle positiveX, FileHandle negativeX,
                   FileHandle positiveY, FileHandle negativeY, FileHandle positiveZ,
                   FileHandle negativeZ) {
        this(positiveX, negativeX, positiveY, negativeY, positiveZ,
                negativeZ, false);
    }
    ...
    public Cubemap(FileHandle positiveX, FileHandle negativeX,
        ...
        this(createTextureData(positiveX, useMipMaps),
                createTextureData(negativeX, useMipMaps), createTextureData(positiveY,
                useMipMaps), createTextureData(negativeY, useMipMaps),
                createTextureData(positiveZ, useMipMaps), createTextureData(
     ...
     * does not generate mipmaps.
     */
    public Cubemap(Pixmap positiveX, Pixmap negativeX, Pixmap positiveY,
    ...
    public Cubemap(Pixmap positiveX, Pixmap negativeX, Pixmap positiveY,
                   Pixmap negativeY, Pixmap positiveZ, Pixmap negativeZ,
                   boolean useMipMaps) {
        this(positiveX == null ? null : new PixmapTextureData(positiveX,
                        null, useMipMaps, false), negativeX == null ? null
                        : new PixmapTextureData(negativeX, null, useMipMaps, false),
                positiveY == null ? null : new PixmapTextureData(positiveY,
                        null, useMipMaps, false), negativeY == null ? null
                        : new PixmapTextureData(negativeY, null, useMipMaps, false),
                positiveZ == null ? null
                        : new PixmapTextureData(positiveZ, null, useMipMaps, false),
                negativeZ == null ? null
    ...
    public Cubemap(int width, int height, int depth, Format format) {
        this(new PixmapTextureData(new Pixmap(depth, height, format), null, false, true),
                new PixmapTextureData(new Pixmap(depth,
                        height, format), null, false, true),
                new PixmapTextureData(new Pixmap(width, depth, format), null, false, true),
                new PixmapTextureData(new Pixmap(width, depth, format), null, false, true),
                new PixmapTextureData(new Pixmap(width,
                        height, format), null, false, true),
     ...
     */
    public Cubemap(TextureData positiveX, TextureData negativeX,
                   TextureData positiveY, TextureData negativeY,
                   TextureData positiveZ, TextureData negativeZ) {
        super(IGL20.GL_TEXTURE_CUBE_MAP);
     ...
     */
    public void load(TextureData positiveX, TextureData negativeX,
                     TextureData positiveY, TextureData negativeY,
                     TextureData positiveZ, TextureData negativeZ) {
        bind();
    ...
    protected void reload() {
        ...
        load(data[CubemapSide.PositiveX.index], data[CubemapSide.NegativeX.index],
                data[CubemapSide.PositiveY.index],
                data[CubemapSide.NegativeY.index], data[CubemapSide.PositiveZ.index],
                data[CubemapSide.NegativeZ.index]);
    }

    /**
     * Loads the texture specified using the {@link FileHandle} and sets it to
     * specified side, overwriting any previous data set to
     * that side. Does not generate mipmaps. This method binds the Cubemap
     * to the active unit!
     *
    ...
    /**
     * Loads the texture specified using the {@link FileHandle} and sets it
     * to specified side, overwriting any previous data set to
    ...
    public void load(CubemapSide side, Pixmap pixmap) {
        load(side, pixmap == null ? null : new PixmapTextureData(pixmap, null,
                false, false));
    }
    ...
    /**
     * Sets the specified side of this cubemap to the specified {@link TextureData},
     ...
     * Sets the specified side of this cubemap to the specified {@link TextureData},
     * overwriting any previous data set to that
     * side. Assumes that the cubemap is bound and active! See also:
     * {@link #load(CubemapSide, TextureData)}
     *
     * @param side The {@link CubemapSide}
     * @param data The {@link TextureData}
     */
    protected void unsafeLoad(CubemapSide side, TextureData data) {
        ...
        if (this.data[idx] != null && data != null
                && data.isManaged() != this.data[idx].isManaged())
    ...
    /**
     * @return The {@link TextureData} for the specified side, can be null
     * if the cubemap is incomplete.
     */
    ...
    public int getWidth() {
        ...
        if (data[CubemapSide.PositiveZ.index] != null
                && (tmp = data[CubemapSide.PositiveZ.index].getWidth()) > width)
            width = tmp;
        if (data[CubemapSide.NegativeZ.index] != null
                && (tmp = data[CubemapSide.NegativeZ.index].getWidth()) > width)
            width = tmp;
        if (data[CubemapSide.PositiveY.index] != null
                && (tmp = data[CubemapSide.PositiveY.index].getWidth()) > width)
            width = tmp;
        if (data[CubemapSide.NegativeY.index] != null
                && (tmp = data[CubemapSide.NegativeY.index].getWidth()) > width)
            width = tmp;
        return width;
    }
    ...
    public int getHeight() {
        int tmp, height = 0;
        if (data[CubemapSide.PositiveZ.index] != null
                && (tmp = data[CubemapSide.PositiveZ.index].getHeight()) > height)
            height = tmp;
        if (data[CubemapSide.NegativeZ.index] != null
                && (tmp = data[CubemapSide.NegativeZ.index].getHeight()) > height)
            height = tmp;
        if (data[CubemapSide.PositiveX.index] != null
                && (tmp = data[CubemapSide.PositiveX.index].getHeight()) > height)
            height = tmp;
        if (data[CubemapSide.NegativeX.index] != null
                && (tmp = data[CubemapSide.NegativeX.index].getHeight()) > height)
            height = tmp;
        return height;
    }
    ...
    public int getDepth() {
        int tmp, depth = 0;
        if (data[CubemapSide.PositiveX.index] != null
                && (tmp = data[CubemapSide.PositiveX.index].getWidth()) > depth)
            depth = tmp;
        if (data[CubemapSide.NegativeX.index] != null
                && (tmp = data[CubemapSide.NegativeX.index].getWidth()) > depth)
            depth = tmp;
        if (data[CubemapSide.PositiveY.index] != null
                && (tmp = data[CubemapSide.PositiveY.index].getHeight()) > depth)
            depth = tmp;
        if (data[CubemapSide.NegativeY.index] != null
                && (tmp = data[CubemapSide.NegativeY.index].getHeight()) > depth)
            depth = tmp;
        return depth;
    }
}
