 ...
 * specify vertices on the fly and provides a default
...
public class ImmediateModeRenderer20 implements ImmediateModeRenderer {
    ...
    public ImmediateModeRenderer20(boolean hasNormals, boolean hasColors,
                                   int numTexCoords) {
    ...
    public ImmediateModeRenderer20(int maxVertices, boolean hasNormals,
    ...
    private VertexAttribute[] buildVertexAttributes(boolean hasNormals,
        ...
        if (hasNormals) attribs.add(new VertexAttribute(Usage.Normal, 3,
                ShaderProgram.NORMAL_ATTRIBUTE));
        if (hasColor) attribs.add(new VertexAttribute(Usage.ColorPacked, 4,
    ...
    static public ShaderProgram createDefaultShader(boolean hasNormals,
        ...
        String vertexShader = createVertexShader(hasNormals, hasColors,
                numTexCoords);
        String fragmentShader = createFragmentShader(hasNormals,
                hasColors, numTexCoords);
        ShaderProgram program = new ShaderProgram(vertexShader,
                fragmentShader);
        return program;
    }
}
