 ...
 */
public class Rectangle implements Serializable,Pool.Poolable {
    /**
     * Static temporary rectangle. Use with care! Use only when sure other
     * code will not also use this.
     */
    ...
    /**
     * Constructs a new rectangle with the given corner point in the
    ...
    /**
     * Merges this rectangle with the other rectangle. The rectangle
     * should not have negative width or negative height.
     *
     * @param rect the other rectangle
     * @return this rectangle for chaining
     */
    ...
    /**
     * Merges this rectangle with a point. The rectangle should not
    ...
    /**
     * Merges this rectangle with a list of points. The rectangle
     * should not have negative width or negative height.
     *
     ...
     *
     * @return the aspect ratio of this rectangle. Returns Float.NaN
     * if height is 0 to avoid ArithmeticException
     */
    ...
    /**
     * Calculates the center of the rectangle. Results are
     * located in the given Vector2
     *
    ...
    /**
     * Moves this rectangle so that its center point is
    ...
    /**
     * Fits this rectangle around another rectangle while maintaining
     * aspect ratio. This scales and centers the rectangle to the
    ...
    /**
     * Fits this rectangle into another rectangle while maintaining
     * aspect ratio. This scales and centers the rectangle to the
     * other rectangle (e.g. Scaling a texture within a arbitrary
     * cell without squeezing)
     *
