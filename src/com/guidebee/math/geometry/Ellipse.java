...
public class Ellipse implements Serializable {
    ...
    /**
     * Constructs a new {@link Ellipse} from the position and radius of
     * a {@link Circle} (since circles are special cases of
     * ellipses).
     *
    ...
    /**
     * @return The area of this {@link Ellipse} as {@link com.guidebee.math.MathUtils#PI}
    ...
    /**
     * Approximates the circumference of this {@link Ellipse}.
     * Oddly enough, the circumference of an ellipse is actually difficult
     * to compute exactly.
     *
     * @return The Ramanujan approximation to the circumference of
     * an ellipse if one dimension is at least three times longer than
