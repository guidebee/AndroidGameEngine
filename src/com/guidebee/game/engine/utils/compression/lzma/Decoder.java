...
public class Decoder {
    class LenDecoder {
        ...
        public void Init() {
            com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(com.guidebee.game.engine.utils.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void Init() {
                com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
            }

            public byte DecodeNormal(com.guidebee.game.engine.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(com.guidebee.game.engine.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
                    throws IOException {
                int symbol = 1;
                do {
    ...
    com.guidebee.game.engine.utils.compression.rangecoder.Decoder m_RangeDecoder = new com.guidebee.game.engine.utils.compression.rangecoder.Decoder();
    ...
    void Init() throws IOException {
        ...
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        com.guidebee.game.engine.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
