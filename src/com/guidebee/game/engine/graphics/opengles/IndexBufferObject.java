...
/**
 * <p>
 * In IndexBufferObject wraps OpenGL's index buffer functionality to be used
 * in conjunction with VBOs. This class can be
...
public class IndexBufferObject implements IndexData {
    ...
    /**
     * <p>
     * Returns the underlying ShortBuffer. If you modify the buffer
     * contents they wil be uploaded on the call to {@link #bind()}.
     * If you need immediate uploading use
     * {@link #setIndices(short[], int, int)}.
     * </p>
     *
    ...
    public void bind() {
        if (bufferHandle == 0)
            throw new GameEngineRuntimeException("No buffer allocated!");
    ...
    /**
     * Invalidates the IndexBufferObject so a new OpenGL buffer handle
    ...
    /**
     * Disposes this IndexBufferObject and all its associated
     * OpenGL resources.
     */
    public void dispose() {
        tmpHandle.clear();
        ...
        tmpHandle.flip();
        GameEngine.gl20.glBindBuffer(IGL20.GL_ELEMENT_ARRAY_BUFFER, 0);
        GameEngine.gl20.glDeleteBuffers(1, tmpHandle);
        bufferHandle = 0;
