 ...
 ******************************************************************************/
//--------------------------------- PACKAGE ------------------------------------
package com.guidebee.game.camera;
...
public class OrthographicCamera extends Camera {
     ...
     * and height. For pixel perfect 2D rendering just supply
     * the screen size, for other unit scales (e.g. meters for box2d)
     * proceed accordingly. The camera will show the region
     * [-viewportWidth/2, -(viewportHeight/2-1)]
    ...
    public void update(boolean updateFrustum) {
        projection.setToOrtho(zoom * -viewportWidth / 2,
                zoom * (viewportWidth / 2), zoom * -(viewportHeight / 2), zoom
    ...
    /**
     * Sets this camera to an orthographic projection using a
     * viewport fitting the screen resolution, centered at
     * (GameEngine.graphics.getWidth()/2, GameEngine.graphics.getHeight()/2),
     * with the y-axis pointing up or down.
     *
     * @param yDown whether y should be pointing down
     */
    public void setToOrtho(boolean yDown) {
        setToOrtho(yDown, GameEngine.graphics.getWidth(),
                GameEngine.graphics.getHeight());
    }

    /**
     * Sets this camera to an orthographic projection, centered at
     * (viewportWidth/2, viewportHeight/2), with the y-axis pointing up
     * or down.
     *
     * @param yDown          whether y should be pointing down.
     * @param viewportWidth
