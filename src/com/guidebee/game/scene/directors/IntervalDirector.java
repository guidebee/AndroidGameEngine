...
//[------------------------------ MAIN CLASS ----------------------------------]
/**
 * A simple Director that does not run its direct logic every call
 * to direct but after a given interval. The actual
 * logic should be placed in {@link IntervalDirector#updateInterval()}.
 *
 * @author David Saltares
 */
public abstract class IntervalDirector extends com.guidebee.game.entity.directors.IntervalDirector {
    /**
